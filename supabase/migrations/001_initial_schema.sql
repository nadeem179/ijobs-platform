...
CREATE TABLE profiles (
  ...
  onboarding_step TEXT DEFAULT 'select_role' CHECK (onboarding_step IS NULL OR onboarding_step IN ('select_role', 'candidate_resume', 'candidate_profile', 'recruiter_profile', 'completed')),
